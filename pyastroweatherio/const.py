...
LIFTED_INDEX_PLAIN = [
    "Below -6, very unstable",
    "-6 to -4, very unstable",
    "-4 to -1.5, unstable",
    "-1.5 to 0, slightly unstable",
    "0 to 1.5, stable",
    "1.5 to 4, stable",
    "4 to 6, very stable",
    "Over 6, very stable",
...
LIFTED_INDEX_7TIMER_MAPPING = dict(
    zip(LIFTED_INDEX_7TIMER_KEYS, LIFTED_INDEX_7TIMER_VALUES)
)
